...
const TEST_HOME = vi.hoisted(() => process.cwd() + (process.platform === 'win32' ? '\\' : '/') + 'test-tmp-material-indexer');
...
/** 全局车道根 = ~/.orison/materials（design §4.4——craft-kb 同级；home mock（os.homedir）→ TEST_HOME/.orison/materials）。 */
